...
/** Streaming job evolved by registering serialized types. */
public class ThroughputJobSolution12 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.registerType(JsonNode.class);
        env.getConfig().registerKryoType(JsonNode.class);
        env.registerType(WindowedMeasurements.class);
        env.getConfig().registerKryoType(WindowedMeasurements.class);
        env.registerType(WindowedMeasurementsForArea.class);
        env.getConfig().registerKryoType(WindowedMeasurementsForArea.class);
        ...
        env.execute(ThroughputJobSolution12.class.getSimpleName());
    }
