...
/** Streaming job evolved by using custom Kryo serializer for WindowedMeasurements */
public class ThroughputJobSolution14 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.execute(ThroughputJobSolution14.class.getSimpleName());
    }
