 ...
 *
 * <p>The timestamps roughly start at the epoch and are ascending per partition. The partitions
 * themselves can be out of sync. *
 */
@DoNotChangeThis
public class FakeKafkaSource extends RichParallelSourceFunction<FakeKafkaRecord>
    ...
    FakeKafkaSource(
            final int seed,
            final float poisonPillRate,
            List<Integer> idlePartitions,
    ...
    public void open(final Configuration parameters) {
        ...
        assignedPartitions =
                IntStream.range(0, NO_OF_PARTIONS)
