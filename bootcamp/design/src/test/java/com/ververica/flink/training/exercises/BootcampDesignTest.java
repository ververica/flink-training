...
import static com.ververica.flink.training.provided.BootcampDesignWorkflowTestUtils.testBootcampDesignWorkflows;

public class BootcampDesignTest {

    @Test
    public void testBridgingWorkflows() throws Exception {
        testBootcampDesignWorkflows(new BootcampDesignAnalyticsWorkflow(),
